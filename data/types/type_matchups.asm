TypeMatchups:
	...
	db ANCIENT,      NORMAL,       SUPER_EFFECTIVE
	db ANCIENT,      FIRE,         SUPER_EFFECTIVE
	db ANCIENT,      FIGHTING,     SUPER_EFFECTIVE
	db ANCIENT,      WATER,        SUPER_EFFECTIVE
	db ANCIENT,      FLYING,       SUPER_EFFECTIVE
	db ANCIENT,      GRASS,        SUPER_EFFECTIVE
	db ANCIENT,      POISON,       SUPER_EFFECTIVE
	db ANCIENT,      ELECTRIC,     SUPER_EFFECTIVE
	db ANCIENT,      GROUND,       SUPER_EFFECTIVE
	db ANCIENT,      PSYCHIC_TYPE, SUPER_EFFECTIVE
	db ANCIENT,      ROCK,         SUPER_EFFECTIVE
	db ANCIENT,      ICE,          SUPER_EFFECTIVE
	db ANCIENT,      BUG,          SUPER_EFFECTIVE
	db ANCIENT,      DRAGON,       SUPER_EFFECTIVE
	db ANCIENT,      GHOST,        SUPER_EFFECTIVE
	db ANCIENT,      DARK,         SUPER_EFFECTIVE
	db ANCIENT,      STEEL,        SUPER_EFFECTIVE
	db ANCIENT,      FAIRY,        SUPER_EFFECTIVE
